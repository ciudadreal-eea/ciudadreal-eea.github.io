...
function mapData(f) {
    ...
    interaction.formatter(function (feature) {
        var o = '<h3>' + feature.properties.título + '</h3>' +
	        '<p><span style="font-weight:bold">Término municipal: ' + feature.properties.términomunicipal + '</span><br>' +
		'<span style="font-weight:bold">Lugar: ' + feature.properties.lugar + '</span></p>';
