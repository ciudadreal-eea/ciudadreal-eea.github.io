$(function () {
    ...
    m.ui.attribution.add().content('<a href="http://www.ecologistasenaccion.org/rubrique52.html">Ecologistas en Acción de Ciudad Real</a>');
    m.ui.zoomer.add();
    m.centerzoom({
    ...
    function addMarker(e) {
        ...
        $('#entry_2').attr('value', l.lat.toFixed(5));
        $('#entry_10').attr('value', l.lon.toFixed(5));
    }
});
